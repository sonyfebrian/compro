    ...
    <>
      ...
      <div className="p-14">
        ...
        <p className="leading-relaxed mb-3 text-gray-600">
          ...
          problem in life. We built PT. DINAMIKA VISUAL KREASINDO (INIDIGI) on
          the basis of enthusiasm and a strong commitment among its founders in
          providing solutions to all business activities of our clients. We
          offer a solution in the form of information technology, which we
          believe will be very useful and will be the best solution to any
          problem in the growing complexity of any existing businesses.DINAMIKA
          VISUAL KREASINDO (INIDIGI) offers a solution in the form of
          information technology. Our company has primary important values:
          quality of services, punctuality, and client’s satisfaction. Therefore
          ...
          addition, our company will also aligned with similar companies to
          optimize our ability to serve all the client’s needs. We have
          professional and qualified management, also technical team who are
          competent in their field. Thus we believe that our companies can
          compete actively, both nationally and globally, in the information
          technology industry.
        </p>
        <p className="leading-relaxed mb-3 text-gray-600">
          ...
          innovation. PT. DINAMIKA VISUAL KREASINDO (INIDIGI) emphasizes the
          uniqueness that is different from its peers. So we dare to be at the
          forefront of the development of Information Technology business
          competition. With our experience and portfolio, as well as good
          relations with an extensive network, PT. DINAMIKA VISUAL KREASINDO
          (INIDIGI) is ready to continue to grow. Our main focus is to build and
          maintain a good reputation, and to increase profitability based on our
          target.
        </p>
        <p className="leading-relaxed mb-3 text-gray-600">
          Information Technology is a field which will never stop growing as
