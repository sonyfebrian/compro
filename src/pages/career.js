    ...
    <div>
      ...
      <section className="px-5 py-5">
        ...
        <p>
          ...
          Must have good presentation capabilities globally as well as
          technically
        </p>
        <p>
          <span className="bg-indigo-100 text-indigo-500 w-4 h-4 mr-2 rounded-full inline-flex items-center justify-center">
        ...
        <p>
          ...
          Candidate must posses at least a Diploma Degree Majoring in
        ...
        <p>
          ...
          Having experience in Information engineering Presale minimum 3 years
        ...
        <p>
          ...
          Willing to work outside the region in accordance with the project
          undertaken
        </p>
        <p>
          <span className="bg-indigo-100 text-indigo-500 w-4 h-4 mr-2 rounded-full inline-flex items-center justify-center">
